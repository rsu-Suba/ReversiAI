...
import { MergeMCTSNode } from "./MCTSNode.mjs";
...
export class MergeMCTSTreeManager {
   ...
   async loadTree(filePath) {
      ...
      try {
         ...
         this.rootNode = MergeMCTSNode.fromSerializableObject(serializableRoot);
   ...
   mergeTrees(otherTreeManager) {
      ...
      if (!this.rootNode) {
         this.rootNode = MergeMCTSNode.fromSerializableObject(otherTreeManager.rootNode.toSerializableObject());
         this._rebuildNodeMap(this.rootNode);
